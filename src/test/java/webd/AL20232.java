...
public class AL20232 {

	public static void main(String[] args) throws InterruptedException, IOException {
		// TODO Auto-generated method stub
		WebDriver driver = new ChromeDriver();
		// Login to application 
		driver.get("https://web-d.tst-34.aws.agilent.com/account/login");
		...
		driver.get("https://web-d.tst-34.aws.agilent.com/sc/332/electron-microscopy-facility/?tab=requests");
